...
p.add_argument('--train_sparsity_range', type=int, nargs='+', default=[1000, 10000],
...
coord_dataset = dataio.Implicit2DWrapper(img_dataset, sidelength=(256, 256), image=False)
