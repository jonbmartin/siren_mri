...
def main(rank, world_size, total_epochs, save_every, load_from_checkpoint_path, experiment_name, B):
    ...
    if config=='hyperoptII':
        ...
        num_fourier_features = 512
        kl_weight = 1e-4#2.78e-8 optim # 0.1 in paper
        fw_weight = 1e-2#1e-6optim # 100 in paper
        lr = 5.e-5
        fourier_features_scale = 20 # best = 10
    ...
    loss_fn = partial(loss_functions.image_hypernetwork_img_domain_loss, None, kl_weight, fw_weight)
...
if __name__ == "__main__":
    ...
    experiment_name = 'DDP_RESET_large_dataset_20featscale_img_domain'
